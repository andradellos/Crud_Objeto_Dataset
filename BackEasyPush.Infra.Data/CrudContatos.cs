...
namespace BackEasyPush.Infra.Data
{
    public class CrudContatos
    {
        ...
        {
            return Base.ExecuteProcedure("Contatos_I", ParametrosUpDateInsert(contato, "I")).RetornoBancoDados;
        }

        public int UpDate(Contato contato)
        {
            return Base.ExecuteProcedure("Contatos_U", ParametrosUpDateInsert(contato,"U")).RetornoBancoDados;
        }
        ...
        public List<ParametrosProcedure> ParametrosUpDateInsert(Contato contato,string UpdateOrInserte)
        {
            ...
            if (UpdateOrInserte == "U") { ListaDeParametros.Add(Base.ParametroProcedure("@IdContato", SqlDbType.Int, contato.IdContato.ToString())); }
